...
export const ListagemExercicios : React.FC = () => {
    
    const [searchParams , setSearchParams] = useSearchParams();
    const {debounce} = useDebounce();
    const navigate = useNavigate();

    const [rows, setRows] = useState<IListagemExercicios[]>([]);
    ...
    useEffect(() => {
        ...
        debounce(() => {
            ...
            ExerciciosService.getAll(pagina,busca)
            .then((result) => {
                setIsLoading(false);
                    ...
                    <TableBody>
                        {rows.map(row =>(
                            ...
                            <TableCell>
                                ...
                                <IconButton size="small" onClick={()=> navigate(`/exercicios/detalhe/${row.id!}`)}>
                                    <Icon>edit</Icon>
                                </IconButton>
